...
class AdapterAllGroupChatList(
    ...
    override fun onCreateViewHolder(
        ...
        val view: View = LayoutInflater.from(context).inflate(
            com.example.adminuser.R.layout.allrow_groupchats_list, parent,
            false
        )
    ...
    override fun onBindViewHolder(holder: HolderGroupChatList, position: Int) {
        ...
        try {
            Picasso.get().load(groupIcon)
                .placeholder(com.example.adminuser.R.drawable.ic_group_primary)
                .into(holder.groupIconIv)
        } catch (e: Exception) {
            holder.groupIconIv.setImageResource(com.example.adminuser.R.drawable.ic_group_primary)
        }
...
//                                else
    ...
    inner class HolderGroupChatList(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            groupIconIv = itemView.findViewById(com.example.adminuser.R.id.groupIconIv)
            groupTitleTv = itemView.findViewById(com.example.adminuser.R.id.groupTitleTv)
            nameTv = itemView.findViewById(com.example.adminuser.R.id.nameTv)
            messageTv = itemView.findViewById(com.example.adminuser.R.id.messageTv)
            timeTv = itemView.findViewById(com.example.adminuser.R.id.timeTv)
        }
    }
